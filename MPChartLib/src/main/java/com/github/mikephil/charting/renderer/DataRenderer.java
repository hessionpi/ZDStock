...
public abstract class DataRenderer extends Renderer {
    ...
    public void drawValue(Canvas c, IValueFormatter formatter, float value, Entry entry, int dataSetIndex, float x, float y, int color) {
        ...
        Bitmap bitmap1 = formatter.getFormattedBitmap(value, entry, dataSetIndex, mViewPortHandler);
        if (bitmap1 != null) {
             c.drawBitmap(bitmap1, x - bitmap1.getWidth() / 2, y - bitmap1.getHeight() / 2, mValuePaint);


        }
        Bitmap bitmap2 = formatter.getFormattedLine(value, entry, dataSetIndex, mViewPortHandler);
        if (bitmap2 != null) {
            // c.drawBitmap(bitmap, x - bitmap.getWidth() / 2, y - bitmap.getHeight() / 2, mValuePaint);
            c.drawBitmap(bitmap2, x - bitmap2.getWidth() / 2, 0, mValuePaint);
