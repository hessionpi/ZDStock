...
public class YAxisRenderer extends AxisRenderer {
    ...
    public void renderAxisLabels(Canvas c) {
        ...
        if (dependency == AxisDependency.LEFT) {
            ...
            } else if((labelPosition == YAxisLabelPosition.INSIDE_CHART)){
        ...
        } else if (dependency == AxisDependency.RIGHT){
            ...
            if (labelPosition == YAxisLabelPosition.OUTSIDE_CHART) {
                mAxisLabelPaint.setTextAlign(Align.LEFT);
                xPos = (mViewPortHandler.contentRight()-mViewPortHandler.offsetLeft())/2 + xoffset;
            } else  if((labelPosition == YAxisLabelPosition.INSIDE_CHART)){
                mAxisLabelPaint.setTextAlign(Align.RIGHT);
                xPos = (mViewPortHandler.contentRight()-mViewPortHandler.offsetLeft())/2 - xoffset;
            }
    ...
    public void renderAxisLine(Canvas c) {
        ...
        } else if (mYAxis.getAxisDependency() == AxisDependency.RIGHT){
            c.drawLine(mViewPortHandler.contentRight(), mViewPortHandler.contentTop(), mViewPortHandler.contentRight(),
                    mViewPortHandler.contentBottom(), mAxisLinePaint);
        }else if (mYAxis.getAxisDependency() == AxisDependency.CENTER){
            c.drawLine(((mViewPortHandler.contentRight()-mViewPortHandler.contentLeft())/2), mViewPortHandler.contentTop(),((mViewPortHandler.contentRight()-mViewPortHandler.contentLeft())/2),
                    mViewPortHandler.contentBottom(), mAxisLinePaint);
        }
    }
