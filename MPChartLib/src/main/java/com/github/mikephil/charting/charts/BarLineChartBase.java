...
public abstract class BarLineChartBase<T extends BarLineScatterCandleBubbleData<? extends
    ...
    protected YAxis mAxisCenter;

    protected YAxisRenderer mAxisRendererLeft;
    protected YAxisRenderer mAxisRendererRight;
    protected YAxisRenderer mAxisRendererCenter;

    protected Transformer mLeftAxisTransformer;
    protected Transformer mRightAxisTransformer;
    protected Transformer mCenterAxisTransformer;
    ...
    protected void init() {
        ...
        mAxisCenter = new YAxis(AxisDependency.CENTER);

        mLeftAxisTransformer = new Transformer(mViewPortHandler);
        mRightAxisTransformer = new Transformer(mViewPortHandler);
        mCenterAxisTransformer = new Transformer(mViewPortHandler);

        mAxisRendererLeft = new YAxisRenderer(mViewPortHandler, mAxisLeft, mLeftAxisTransformer);
        mAxisRendererRight = new YAxisRenderer(mViewPortHandler, mAxisRight, mRightAxisTransformer);
        mAxisRendererCenter = new YAxisRenderer(mViewPortHandler, mAxisCenter, mRightAxisTransformer);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mAxisCenter.isEnabled())
            mAxisRendererCenter.computeAxis(mAxisCenter.mAxisMinimum, mAxisCenter.mAxisMaximum, mAxisCenter.isInverted());
        if (mXAxis.isEnabled())
        ...
        mAxisRendererCenter.renderAxisLine(canvas);
        ...
        mAxisRendererCenter.renderGridLines(canvas);
        ...
        if (mAxisCenter.isDrawLimitLinesBehindDataEnabled())
            mAxisRendererCenter.renderLimitLines(canvas);
    ...
    protected void prepareValuePxMatrix() {
        ...
        mCenterAxisTransformer.prepareMatrixValuePx(mXAxis.mAxisMinimum,
                mXAxis.mAxisRange,
                mAxisCenter.mAxisRange,
                mAxisCenter.mAxisMinimum);
    }
    ...
    protected void prepareOffsetMatrix() {
        ...
        mCenterAxisTransformer.prepareMatrixOffset(mAxisCenter.isInverted());
    }
    ...
    public void notifyDataSetChanged() {
        ...
        mAxisRendererLeft.computeAxis(mAxisLeft.mAxisMinimum, mAxisLeft.mAxisMaximum, mAxisLeft.isInverted());
        mAxisRendererRight.computeAxis(mAxisRight.mAxisMinimum, mAxisRight.mAxisMaximum, mAxisRight.isInverted());
        mAxisRendererCenter.computeAxis(mAxisRight.mAxisMinimum, mAxisCenter.mAxisMaximum, mAxisRight.isInverted());
        mXAxisRenderer.computeAxis(mXAxis.mAxisMinimum, mXAxis.mAxisMaximum, false);
    ...
    protected void autoScale() {
        ...
        mAxisRight.calculate(mData.getYMin(AxisDependency.RIGHT), mData.getYMax(AxisDependency
                .RIGHT));
        mAxisCenter.calculate(mData.getYMin(AxisDependency.CENTER), mData.getYMax(AxisDependency.CENTER));
        calculateOffsets();
    }
    ...
    public Transformer getTransformer(AxisDependency which) {
        ...
        else if (which == AxisDependency.RIGHT)
            return mRightAxisTransformer;
        else  return mCenterAxisTransformer;
    }
