package com.rjzd.aistock.ui.views.stockcharts.stockchart.utils;
...
public class DrawUtils {
    //分时图时间、价格、涨幅文字大小
    public static final float FENSHI_TEXT_SIZE = PixelUtil.dp2px(7);
    //时间文字大小
    public static final float FENSHI_TIME_SIZE = PixelUtil.dp2px(8);
    //当文字在最上方的时候，需要往下偏移，如高的涨幅
    public static final float FENSHI_TEXT_OFFSET = PixelUtil.dp2px(8);
    ...
    public static void drawPriceShader(Canvas canvas, float[] prices, float xUnit, float height, float max, float min) {
       ...
       // Shader mShasder = new LinearGradient(0, 0, 0, height, new int[]{Color.parseColor("#aa3483e9"), Color.parseColor("#303483e9")}, null, Shader.TileMode.CLAMP);
        Shader mShasder = new LinearGradient(0, 0, 0, height, new int[]{Color.parseColor("#303483e9"), Color.parseColor("#303483e9")}, null, Shader.TileMode.CLAMP);
    ...
    public static void drawXTime(Canvas canvas, String duration, long time, float width, float height) {
       ...
       // String leftTime="09:30";
        ...
        //上面偏移一点
        height = height + PixelUtil.dp2px(9);
        Paint p = new Paint();
     ...
     * @param height
     */
    public static void drawKLineXTime(Canvas canvas, String s1, String s2, float width,float totalwidth, float height) {
        //上面偏移一点
      //  height = height + 25;
        height = height + PixelUtil.dp2px(9);
        Paint p = new Paint();
        ...
        p.setTextAlign(Paint.Align.RIGHT);
        if (s2 != null&&width>=totalwidth/4.0)
