...
public class ColorUtil {
    ...
    //跌颜色
    public static final int COLOR_GREEN = Color.parseColor("#119d3e");
    //涨颜色
    public static final int COLOR_RED = Color.parseColor("#d63535");
    //平灰
    ...
    //分时线价格颜色
   // public static final int COLOR_PRICE_LINE = Color.parseColor("#ff3483e9");
    public static final int COLOR_PRICE_LINE = Color.parseColor("#1e82d2");
    //分时线均线颜色
