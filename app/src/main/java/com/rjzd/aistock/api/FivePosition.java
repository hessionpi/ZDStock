...
public class FivePosition implements org.apache.thrift.TBase<FivePosition, FivePosition._Fields>, java.io.Serializable, Cloneable, Comparable<FivePosition>, android.os.Parcelable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("FivePosition");
  ...
  private static final org.apache.thrift.protocol.TField VOLUME_FIELD_DESC = new org.apache.thrift.protocol.TField("volume", org.apache.thrift.protocol.TType.I64, (short)3);

  private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
  static {
    schemes.put(StandardScheme.class, new FivePositionStandardSchemeFactory());
    schemes.put(TupleScheme.class, new FivePositionTupleSchemeFactory());
  }
  ...
  public FivePosition(android.os.Parcel in) {
    //primitive bitfield of type: byte
  ...
  public static final android.os.Parcelable.Creator<FivePosition> CREATOR = new android.os.Parcelable.Creator<FivePosition>() {
    @Override
    public FivePosition[] newArray(int size) {
      return new FivePosition[size];
    }

    @Override
    public FivePosition createFromParcel(android.os.Parcel in) {
      return new FivePosition(in);
    }
  };
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(FivePosition.class, metaDataMap);
  }
   ...
   */
  public FivePosition(FivePosition other) {
  ...
  public FivePosition deepCopy() {
    return new FivePosition(this);
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof FivePosition)
      return this.equals((FivePosition)that);
    return false;
  }

  public boolean equals(FivePosition that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(FivePosition other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("FivePosition(");
    boolean first = true;
  ...
  private static class FivePositionStandardSchemeFactory implements SchemeFactory {
    public FivePositionStandardScheme getScheme() {
      return new FivePositionStandardScheme();
    }
  }

  private static class FivePositionStandardScheme extends StandardScheme<FivePosition> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, FivePosition struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, FivePosition struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class FivePositionTupleSchemeFactory implements SchemeFactory {
    public FivePositionTupleScheme getScheme() {
      return new FivePositionTupleScheme();
    }
  }

  private static class FivePositionTupleScheme extends TupleScheme<FivePosition> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, FivePosition struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, FivePosition struct) throws org.apache.thrift.TException {
