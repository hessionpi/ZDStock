...
public class AIAttention implements org.apache.thrift.TBase<AIAttention, AIAttention._Fields>, java.io.Serializable, Cloneable, Comparable<AIAttention>, android.os.Parcelable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("AIAttention");
  ...
  static {
    schemes.put(StandardScheme.class, new AIAttentionStandardSchemeFactory());
    schemes.put(TupleScheme.class, new AIAttentionTupleSchemeFactory());
  }

  private StatusCode status; // required
  private List<String> data; // required
  ...
  public AIAttention(android.os.Parcel in) {
    this.status = StatusCode.findByValue(in.readInt());
    this.data = new ArrayList<String>();
    in.readList(this.data, AIAttention.class.getClassLoader());
    this.msg= in.readString();
  }

  public static final android.os.Parcelable.Creator<AIAttention> CREATOR = new android.os.Parcelable.Creator<AIAttention>() {
    @Override
    public AIAttention[] newArray(int size) {
      return new AIAttention[size];
    }

    @Override
    public AIAttention createFromParcel(android.os.Parcel in) {
      return new AIAttention(in);
    }
  };
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(AIAttention.class, metaDataMap);
  }
   ...
   */
  public AIAttention(AIAttention other) {
  ...
  public AIAttention deepCopy() {
    return new AIAttention(this);
  }
  ...
  public java.util.Iterator<String> get_data_iterator() {
    return (this.data == null) ? null : this.data.iterator();
  }

  public void add_to_data(String elem) {
    if (this.data == null) {
      this.data = new ArrayList<String>();
    }
    this.data.add(elem);
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof AIAttention)
      return this.equals((AIAttention)that);
    return false;
  }

  public boolean equals(AIAttention that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(AIAttention other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("AIAttention(");
    boolean first = true;
  ...
  private static class AIAttentionStandardSchemeFactory implements SchemeFactory {
    public AIAttentionStandardScheme getScheme() {
      return new AIAttentionStandardScheme();
    }
  }

  private static class AIAttentionStandardScheme extends StandardScheme<AIAttention> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, AIAttention struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, AIAttention struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.data != null) {
        oprot.writeFieldBegin(DATA_FIELD_DESC);
        {
          ...
          for (String _iter347 : struct.data)
          {
  ...
  private static class AIAttentionTupleSchemeFactory implements SchemeFactory {
    public AIAttentionTupleScheme getScheme() {
      return new AIAttentionTupleScheme();
    }
  }

  private static class AIAttentionTupleScheme extends TupleScheme<AIAttention> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, AIAttention struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      oprot.writeI32(struct.status.getValue());
      {
        oprot.writeI32(struct.data.size());
        for (String _iter348 : struct.data)
        {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, AIAttention struct) throws org.apache.thrift.TException {
      ...
      struct.set_status_isSet(true);
      {
        ...
        if (struct.data == null) {
          struct.data = new ArrayList<String>(_list349.size);
        }
        String _elem350 = null;
        for (int _i351 = 0; _i351 < _list349.size; ++_i351)
        {
          _elem350 = iprot.readString();
          struct.data.add(_elem350);
        }
      }
      struct.set_data_isSet(true);
      struct.msg = iprot.readString();
