...
public class AIList implements org.apache.thrift.TBase<AIList, AIList._Fields>, java.io.Serializable, Cloneable, Comparable<AIList>, android.os.Parcelable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("AIList");
  ...
  static {
    schemes.put(StandardScheme.class, new AIListStandardSchemeFactory());
    schemes.put(TupleScheme.class, new AIListTupleSchemeFactory());
  }

  private StatusCode status; // required
  private List<AIInfo> data; // required
  ...
  public AIList(android.os.Parcel in) {
    this.status = StatusCode.findByValue(in.readInt());
    this.data = new ArrayList<AIInfo>();
    in.readTypedList(this.data, AIInfo.CREATOR);
    this.msg= in.readString();
  }

  public static final android.os.Parcelable.Creator<AIList> CREATOR = new android.os.Parcelable.Creator<AIList>() {
    @Override
    public AIList[] newArray(int size) {
      return new AIList[size];
    }

    @Override
    public AIList createFromParcel(android.os.Parcel in) {
      return new AIList(in);
    }
  };
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(AIList.class, metaDataMap);
  }
   ...
   */
  public AIList(AIList other) {
    if (other.is_set_status()) {
      this.status = other.status;
    }
    if (other.is_set_data()) {
      List<AIInfo> __this__data = new ArrayList<AIInfo>(other.data.size());
      for (AIInfo other_element : other.data) {
        __this__data.add(new AIInfo(other_element));
      }
  ...
  public java.util.Iterator<AIInfo> get_data_iterator() {
    return (this.data == null) ? null : this.data.iterator();
  }

  public void add_to_data(AIInfo elem) {
    if (this.data == null) {
      this.data = new ArrayList<AIInfo>();
    }
    this.data.add(elem);
  ...
  public List<AIInfo> get_data() {
    return this.data;
  }

  public void set_data(List<AIInfo> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof AIList)
      return this.equals((AIList)that);
    return false;
  }

  public boolean equals(AIList that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(AIList other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("AIList(");
    boolean first = true;
  ...
  private static class AIListStandardSchemeFactory implements SchemeFactory {
    public AIListStandardScheme getScheme() {
      return new AIListStandardScheme();
    }
  }

  private static class AIListStandardScheme extends StandardScheme<AIList> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, AIList struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                if (struct.data == null) {
                  struct.data = new ArrayList<AIInfo>(_list336.size);
                }
                AIInfo _elem337 = new AIInfo();
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, AIList struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.data != null) {
        oprot.writeFieldBegin(DATA_FIELD_DESC);
        {
          ...
          for (AIInfo _iter339 : struct.data)
          {
  ...
  private static class AIListTupleSchemeFactory implements SchemeFactory {
    public AIListTupleScheme getScheme() {
      return new AIListTupleScheme();
    }
  }

  private static class AIListTupleScheme extends TupleScheme<AIList> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, AIList struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      oprot.writeI32(struct.status.getValue());
      {
        oprot.writeI32(struct.data.size());
        for (AIInfo _iter340 : struct.data)
        {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, AIList struct) throws org.apache.thrift.TException {
      ...
      struct.set_status_isSet(true);
      {
        ...
        if (struct.data == null) {
          struct.data = new ArrayList<AIInfo>(_list341.size);
        }
        AIInfo _elem342 = new AIInfo();
