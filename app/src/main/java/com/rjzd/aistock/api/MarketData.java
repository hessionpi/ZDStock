...
public class MarketData implements org.apache.thrift.TBase<MarketData, MarketData._Fields>, java.io.Serializable, Cloneable, Comparable<MarketData>, android.os.Parcelable {
  ...
  private List<Market> data; // required
  ...
  public MarketData(android.os.Parcel in) {
    //primitive bitfield of type: byte
    __isset_bitfield = in.readByte();

    this.status = StatusCode.findByValue(in.readInt());
    this.data = new ArrayList<Market>();
    in.readTypedList(this.data, Market.CREATOR);
    this.totalPage = in.readInt();
    this.msg= in.readString();
  }

  public static final android.os.Parcelable.Creator<MarketData> CREATOR = new android.os.Parcelable.Creator<MarketData>() {
    @Override
    ...
    @Override
    public MarketData createFromParcel(android.os.Parcel in) {
  ...
  static {
    ...
    tmpMap.put(_Fields.DATA, new org.apache.thrift.meta_data.FieldMetaData("data", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, Market.class))));
  ...
  public MarketData(MarketData other) {
    ...
    if (other.is_set_data()) {
      List<Market> __this__data = new ArrayList<Market>(other.data.size());
      for (Market other_element : other.data) {
        __this__data.add(new Market(other_element));
      }
  ...
  public java.util.Iterator<Market> get_data_iterator() {
    return (this.data == null) ? null : this.data.iterator();
  }

  public void add_to_data(Market elem) {
    if (this.data == null) {
      this.data = new ArrayList<Market>();
    }
    this.data.add(elem);
  ...
  public List<Market> get_data() {
    return this.data;
  }

  public void set_data(List<Market> data) {
    this.data = data;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                if (struct.data == null) {
                  struct.data = new ArrayList<Market>(_list48.size);
                }
                Market _elem49 = new Market();
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, MarketData struct) throws org.apache.thrift.TException {
      ...
      if (struct.data != null) {
        oprot.writeFieldBegin(DATA_FIELD_DESC);
        {
          ...
          for (Market _iter51 : struct.data)
          {
            _iter51.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class MarketDataTupleScheme extends TupleScheme<MarketData> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, MarketData struct) throws org.apache.thrift.TException {
      ...
      oprot.writeI32(struct.status.getValue());
      {
        ...
        for (Market _iter52 : struct.data)
        {
          _iter52.write(oprot);
        }
      }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, MarketData struct) throws org.apache.thrift.TException {
      ...
      struct.set_status_isSet(true);
      {
        ...
        if (struct.data == null) {
          struct.data = new ArrayList<Market>(_list53.size);
        }
        Market _elem54 = new Market();
