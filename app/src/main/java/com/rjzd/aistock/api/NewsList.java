...
public class NewsList implements org.apache.thrift.TBase<NewsList, NewsList._Fields>, java.io.Serializable, Cloneable, Comparable<NewsList>, android.os.Parcelable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("NewsList");
  ...
  static {
    schemes.put(StandardScheme.class, new NewsListStandardSchemeFactory());
    schemes.put(TupleScheme.class, new NewsListTupleSchemeFactory());
  }

  private StatusCode status; // required
  private List<News> data; // required
  private String msg; // required
  private int pageNo; // optional
  ...
  public NewsList(android.os.Parcel in) {
    //primitive bitfield of type: byte
    __isset_bitfield = in.readByte();

    this.status = StatusCode.findByValue(in.readInt());
    this.data = new ArrayList<News>();
    in.readTypedList(this.data, News.CREATOR);
    this.msg= in.readString();
    this.pageNo = in.readInt();
    this.totalPage = in.readInt();
  }

  public static final android.os.Parcelable.Creator<NewsList> CREATOR = new android.os.Parcelable.Creator<NewsList>() {
    @Override
  ...
  private static final _Fields optionals[] = {_Fields.PAGE_NO};
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(NewsList.class, metaDataMap);
  }
   ...
   */
  public NewsList(NewsList other) {
  ...
  public java.util.Iterator<News> get_data_iterator() {
    return (this.data == null) ? null : this.data.iterator();
  }

  public void add_to_data(News elem) {
    if (this.data == null) {
      this.data = new ArrayList<News>();
    }
    this.data.add(elem);
  ...
  public List<News> get_data() {
    return this.data;
  }

  public void set_data(List<News> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof NewsList)
      return this.equals((NewsList)that);
    return false;
  }

  public boolean equals(NewsList that) {
    if (that == null)
      return false;
    ...
    boolean this_present_pageNo = true && this.is_set_pageNo();
    boolean that_present_pageNo = true && that.is_set_pageNo();
  ...
  public int hashCode() {
    ...
    boolean present_pageNo = true && (is_set_pageNo());
  ...
  @Override
  public int compareTo(NewsList other) {
  ...
  private static class NewsListStandardSchemeFactory implements SchemeFactory {
    public NewsListStandardScheme getScheme() {
      return new NewsListStandardScheme();
    }
  }

  private static class NewsListStandardScheme extends StandardScheme<NewsList> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, NewsList struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                if (struct.data == null) {
                  struct.data = new ArrayList<News>(_list40.size);
                }
                News _elem41 = new News();
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, NewsList struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class NewsListTupleSchemeFactory implements SchemeFactory {
    public NewsListTupleScheme getScheme() {
      return new NewsListTupleScheme();
    }
  }

  private static class NewsListTupleScheme extends TupleScheme<NewsList> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, NewsList struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      oprot.writeI32(struct.status.getValue());
      {
        oprot.writeI32(struct.data.size());
        for (News _iter44 : struct.data)
        {
          _iter44.write(oprot);
        }
      }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, NewsList struct) throws org.apache.thrift.TException {
      ...
      struct.set_status_isSet(true);
      {
        ...
        if (struct.data == null) {
          struct.data = new ArrayList<News>(_list45.size);
        }
        News _elem46 = new News();
