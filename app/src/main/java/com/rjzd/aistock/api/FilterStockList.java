...
public class FilterStockList implements org.apache.thrift.TBase<FilterStockList, FilterStockList._Fields>, java.io.Serializable, Cloneable, Comparable<FilterStockList>, android.os.Parcelable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("FilterStockList");
  ...
  static {
    schemes.put(StandardScheme.class, new FilterStockListStandardSchemeFactory());
    schemes.put(TupleScheme.class, new FilterStockListTupleSchemeFactory());
  }

  private StatusCode status; // required
  private List<FilterStockResult> data; // required
  ...
  public FilterStockList(android.os.Parcel in) {
    //primitive bitfield of type: byte
    __isset_bitfield = in.readByte();

    this.status = StatusCode.findByValue(in.readInt());
    this.data = new ArrayList<FilterStockResult>();
    in.readTypedList(this.data, FilterStockResult.CREATOR);
    this.msg= in.readString();
    this.total = in.readInt();
    this.totalPage = in.readInt();
  }

  public static final android.os.Parcelable.Creator<FilterStockList> CREATOR = new android.os.Parcelable.Creator<FilterStockList>() {
    @Override
    public FilterStockList[] newArray(int size) {
      return new FilterStockList[size];
    }

    @Override
    public FilterStockList createFromParcel(android.os.Parcel in) {
      return new FilterStockList(in);
    }
  };
  ...
  static {
    ...
    tmpMap.put(_Fields.DATA, new org.apache.thrift.meta_data.FieldMetaData("data", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, FilterStockResult.class))));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(FilterStockList.class, metaDataMap);
  }

  public FilterStockList() {
  }

  public FilterStockList(
    StatusCode status,
    List<FilterStockResult> data,
    String msg,
    int total,
    int totalPage)
  {
   ...
   */
  public FilterStockList(FilterStockList other) {
    __isset_bitfield = other.__isset_bitfield;
    if (other.is_set_status()) {
      this.status = other.status;
    }
    if (other.is_set_data()) {
      List<FilterStockResult> __this__data = new ArrayList<FilterStockResult>(other.data.size());
      for (FilterStockResult other_element : other.data) {
        __this__data.add(new FilterStockResult(other_element));
      }
  ...
  public FilterStockList deepCopy() {
    return new FilterStockList(this);
  }
  ...
  public java.util.Iterator<FilterStockResult> get_data_iterator() {
    return (this.data == null) ? null : this.data.iterator();
  }

  public void add_to_data(FilterStockResult elem) {
    if (this.data == null) {
      this.data = new ArrayList<FilterStockResult>();
    }
    this.data.add(elem);
  ...
  public List<FilterStockResult> get_data() {
    return this.data;
  }

  public void set_data(List<FilterStockResult> data) {
    this.data = data;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case DATA:
      if (value == null) {
        ...
        set_data((List<FilterStockResult>)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof FilterStockList)
      return this.equals((FilterStockList)that);
    return false;
  }

  public boolean equals(FilterStockList that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(FilterStockList other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("FilterStockList(");
    boolean first = true;
  ...
  private static class FilterStockListStandardSchemeFactory implements SchemeFactory {
    public FilterStockListStandardScheme getScheme() {
      return new FilterStockListStandardScheme();
    }
  }

  private static class FilterStockListStandardScheme extends StandardScheme<FilterStockList> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, FilterStockList struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                if (struct.data == null) {
                  struct.data = new ArrayList<FilterStockResult>(_list32.size);
                }
                FilterStockResult _elem33 = new FilterStockResult();
                for (int _i34 = 0; _i34 < _list32.size; ++_i34)
                {
                  if (_elem33 == null) {
                    _elem33 = new FilterStockResult();
                  }
                  _elem33.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, FilterStockList struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.data != null) {
        oprot.writeFieldBegin(DATA_FIELD_DESC);
        {
          ...
          for (FilterStockResult _iter35 : struct.data)
          {
            _iter35.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class FilterStockListTupleSchemeFactory implements SchemeFactory {
    public FilterStockListTupleScheme getScheme() {
      return new FilterStockListTupleScheme();
    }
  }

  private static class FilterStockListTupleScheme extends TupleScheme<FilterStockList> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, FilterStockList struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      oprot.writeI32(struct.status.getValue());
      {
        oprot.writeI32(struct.data.size());
        for (FilterStockResult _iter36 : struct.data)
        {
          _iter36.write(oprot);
        }
      }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, FilterStockList struct) throws org.apache.thrift.TException {
      ...
      struct.set_status_isSet(true);
      {
        ...
        if (struct.data == null) {
          struct.data = new ArrayList<FilterStockResult>(_list37.size);
        }
        FilterStockResult _elem38 = new FilterStockResult();
        for (int _i39 = 0; _i39 < _list37.size; ++_i39)
        {
          if (_elem38 == null) {
            _elem38 = new FilterStockResult();
          }
          _elem38.read(iprot);
