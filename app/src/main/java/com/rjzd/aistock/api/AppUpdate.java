...
public class AppUpdate implements org.apache.thrift.TBase<AppUpdate, AppUpdate._Fields>, java.io.Serializable, Cloneable, Comparable<AppUpdate>, android.os.Parcelable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("AppUpdate");
  ...
  static {
    schemes.put(StandardScheme.class, new AppUpdateStandardSchemeFactory());
    schemes.put(TupleScheme.class, new AppUpdateTupleSchemeFactory());
  }

  private StatusCode status; // required
  private AppUpdateInfo data; // optional
  ...
  public AppUpdate(android.os.Parcel in) {
    this.status = StatusCode.findByValue(in.readInt());
    this.data= in.readParcelable(AppUpdate.class.getClassLoader());
    this.msg= in.readString();
  }

  public static final android.os.Parcelable.Creator<AppUpdate> CREATOR = new android.os.Parcelable.Creator<AppUpdate>() {
    @Override
    ...
    @Override
    public AppUpdate createFromParcel(android.os.Parcel in) {
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(AppUpdate.class, metaDataMap);
  }
   ...
   */
  public AppUpdate(AppUpdate other) {
    if (other.is_set_status()) {
      this.status = other.status;
    }
    if (other.is_set_data()) {
      this.data = new AppUpdateInfo(other.data);
    }
    if (other.is_set_msg()) {
      this.msg = other.msg;
    }
  ...
  public AppUpdateInfo get_data() {
    return this.data;
  }

  public void set_data(AppUpdateInfo data) {
    this.data = data;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof AppUpdate)
      return this.equals((AppUpdate)that);
    return false;
  }

  public boolean equals(AppUpdate that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(AppUpdate other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("AppUpdate(");
    boolean first = true;
  ...
  private static class AppUpdateStandardSchemeFactory implements SchemeFactory {
    public AppUpdateStandardScheme getScheme() {
      return new AppUpdateStandardScheme();
    }
  }

  private static class AppUpdateStandardScheme extends StandardScheme<AppUpdate> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, AppUpdate struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, AppUpdate struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class AppUpdateTupleSchemeFactory implements SchemeFactory {
    public AppUpdateTupleScheme getScheme() {
      return new AppUpdateTupleScheme();
    }
  }

  private static class AppUpdateTupleScheme extends TupleScheme<AppUpdate> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, AppUpdate struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, AppUpdate struct) throws org.apache.thrift.TException {
