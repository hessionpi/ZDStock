...
public class DateTransferList implements org.apache.thrift.TBase<DateTransferList, DateTransferList._Fields>, java.io.Serializable, Cloneable, Comparable<DateTransferList>, android.os.Parcelable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("DateTransferList");
  ...
  static {
    schemes.put(StandardScheme.class, new DateTransferListStandardSchemeFactory());
    schemes.put(TupleScheme.class, new DateTransferListTupleSchemeFactory());
  }

  private StatusCode status; // required
  private List<DateTransfer> data; // required
  ...
  public DateTransferList(android.os.Parcel in) {
    //primitive bitfield of type: byte
    __isset_bitfield = in.readByte();

    this.status = StatusCode.findByValue(in.readInt());
    this.data = new ArrayList<DateTransfer>();
    in.readTypedList(this.data, DateTransfer.CREATOR);
    this.totalPage = in.readInt();
    this.msg= in.readString();
  }

  public static final android.os.Parcelable.Creator<DateTransferList> CREATOR = new android.os.Parcelable.Creator<DateTransferList>() {
    @Override
    public DateTransferList[] newArray(int size) {
      return new DateTransferList[size];
    }

    @Override
    public DateTransferList createFromParcel(android.os.Parcel in) {
      return new DateTransferList(in);
    }
  };
  ...
  static {
    ...
    tmpMap.put(_Fields.DATA, new org.apache.thrift.meta_data.FieldMetaData("data", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, DateTransfer.class))));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(DateTransferList.class, metaDataMap);
  }

  public DateTransferList() {
  }

  public DateTransferList(
    StatusCode status,
    List<DateTransfer> data,
    int totalPage,
    String msg)
  {
    this();
   ...
   */
  public DateTransferList(DateTransferList other) {
    __isset_bitfield = other.__isset_bitfield;
    if (other.is_set_status()) {
      this.status = other.status;
    }
    if (other.is_set_data()) {
      List<DateTransfer> __this__data = new ArrayList<DateTransfer>(other.data.size());
      for (DateTransfer other_element : other.data) {
        __this__data.add(new DateTransfer(other_element));
      }
  ...
  public DateTransferList deepCopy() {
    return new DateTransferList(this);
  }
  ...
  public java.util.Iterator<DateTransfer> get_data_iterator() {
    return (this.data == null) ? null : this.data.iterator();
  }

  public void add_to_data(DateTransfer elem) {
    if (this.data == null) {
      this.data = new ArrayList<DateTransfer>();
    }
    this.data.add(elem);
  ...
  public List<DateTransfer> get_data() {
    return this.data;
  }

  public void set_data(List<DateTransfer> data) {
    this.data = data;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case DATA:
      if (value == null) {
        ...
        set_data((List<DateTransfer>)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof DateTransferList)
      return this.equals((DateTransferList)that);
    return false;
  }

  public boolean equals(DateTransferList that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(DateTransferList other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("DateTransferList(");
    boolean first = true;
  ...
  private static class DateTransferListStandardSchemeFactory implements SchemeFactory {
    public DateTransferListStandardScheme getScheme() {
      return new DateTransferListStandardScheme();
    }
  }

  private static class DateTransferListStandardScheme extends StandardScheme<DateTransferList> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, DateTransferList struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                if (struct.data == null) {
                  struct.data = new ArrayList<DateTransfer>(_list392.size);
                }
                DateTransfer _elem393 = new DateTransfer();
                for (int _i394 = 0; _i394 < _list392.size; ++_i394)
                {
                  if (_elem393 == null) {
                    _elem393 = new DateTransfer();
                  }
                  _elem393.read(iprot);
                  struct.data.add(_elem393);
                  _elem393 = null;
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, DateTransferList struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.data != null) {
        oprot.writeFieldBegin(DATA_FIELD_DESC);
        {
          ...
          for (DateTransfer _iter395 : struct.data)
          {
  ...
  private static class DateTransferListTupleSchemeFactory implements SchemeFactory {
    public DateTransferListTupleScheme getScheme() {
      return new DateTransferListTupleScheme();
    }
  }

  private static class DateTransferListTupleScheme extends TupleScheme<DateTransferList> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, DateTransferList struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      oprot.writeI32(struct.status.getValue());
      {
        oprot.writeI32(struct.data.size());
        for (DateTransfer _iter396 : struct.data)
        {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, DateTransferList struct) throws org.apache.thrift.TException {
      ...
      struct.set_status_isSet(true);
      {
        ...
        if (struct.data == null) {
          struct.data = new ArrayList<DateTransfer>(_list397.size);
        }
        DateTransfer _elem398 = new DateTransfer();
        for (int _i399 = 0; _i399 < _list397.size; ++_i399)
        {
          if (_elem398 == null) {
            _elem398 = new DateTransfer();
          }
          _elem398.read(iprot);
          struct.data.add(_elem398);
          _elem398 = null;
        }
      }
      struct.set_data_isSet(true);
