...
public class AnnouncementData implements org.apache.thrift.TBase<AnnouncementData, AnnouncementData._Fields>, java.io.Serializable, Cloneable, Comparable<AnnouncementData>, android.os.Parcelable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("AnnouncementData");
  ...
  static {
    schemes.put(StandardScheme.class, new AnnouncementDataStandardSchemeFactory());
    schemes.put(TupleScheme.class, new AnnouncementDataTupleSchemeFactory());
  }

  private StatusCode status; // required
  private List<Announcement> data; // required
  ...
  public AnnouncementData(android.os.Parcel in) {
    //primitive bitfield of type: byte
    __isset_bitfield = in.readByte();

    this.status = StatusCode.findByValue(in.readInt());
    this.data = new ArrayList<Announcement>();
    in.readTypedList(this.data, Announcement.CREATOR);
    this.msg= in.readString();
    this.totalPage = in.readInt();
  }

  public static final android.os.Parcelable.Creator<AnnouncementData> CREATOR = new android.os.Parcelable.Creator<AnnouncementData>() {
    @Override
    ...
    @Override
    public AnnouncementData createFromParcel(android.os.Parcel in) {
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(AnnouncementData.class, metaDataMap);
  }
   ...
   */
  public AnnouncementData(AnnouncementData other) {
    __isset_bitfield = other.__isset_bitfield;
    if (other.is_set_status()) {
      this.status = other.status;
    }
    if (other.is_set_data()) {
      List<Announcement> __this__data = new ArrayList<Announcement>(other.data.size());
      for (Announcement other_element : other.data) {
        __this__data.add(new Announcement(other_element));
      }
  ...
  public AnnouncementData deepCopy() {
    return new AnnouncementData(this);
  }
  ...
  public java.util.Iterator<Announcement> get_data_iterator() {
    return (this.data == null) ? null : this.data.iterator();
  }

  public void add_to_data(Announcement elem) {
    if (this.data == null) {
      this.data = new ArrayList<Announcement>();
    }
    this.data.add(elem);
  ...
  public List<Announcement> get_data() {
    return this.data;
  }

  public void set_data(List<Announcement> data) {
    this.data = data;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case DATA:
      if (value == null) {
        ...
        set_data((List<Announcement>)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof AnnouncementData)
      return this.equals((AnnouncementData)that);
    return false;
  }

  public boolean equals(AnnouncementData that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(AnnouncementData other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("AnnouncementData(");
    boolean first = true;
  ...
  private static class AnnouncementDataStandardSchemeFactory implements SchemeFactory {
    public AnnouncementDataStandardScheme getScheme() {
      return new AnnouncementDataStandardScheme();
    }
  }

  private static class AnnouncementDataStandardScheme extends StandardScheme<AnnouncementData> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, AnnouncementData struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                if (struct.data == null) {
                  struct.data = new ArrayList<Announcement>(_list450.size);
                }
                Announcement _elem451 = new Announcement();
                for (int _i452 = 0; _i452 < _list450.size; ++_i452)
                {
                  if (_elem451 == null) {
                    _elem451 = new Announcement();
                  }
                  _elem451.read(iprot);
                  struct.data.add(_elem451);
                  _elem451 = null;
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, AnnouncementData struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.data != null) {
        oprot.writeFieldBegin(DATA_FIELD_DESC);
        {
          ...
          for (Announcement _iter453 : struct.data)
          {
  ...
  private static class AnnouncementDataTupleSchemeFactory implements SchemeFactory {
    public AnnouncementDataTupleScheme getScheme() {
      return new AnnouncementDataTupleScheme();
    }
  }

  private static class AnnouncementDataTupleScheme extends TupleScheme<AnnouncementData> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, AnnouncementData struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      oprot.writeI32(struct.status.getValue());
      {
        oprot.writeI32(struct.data.size());
        for (Announcement _iter454 : struct.data)
        {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, AnnouncementData struct) throws org.apache.thrift.TException {
      ...
      struct.set_status_isSet(true);
      {
        ...
        if (struct.data == null) {
          struct.data = new ArrayList<Announcement>(_list455.size);
        }
        Announcement _elem456 = new Announcement();
        for (int _i457 = 0; _i457 < _list455.size; ++_i457)
        {
          if (_elem456 == null) {
            _elem456 = new Announcement();
          }
          _elem456.read(iprot);
          struct.data.add(_elem456);
          _elem456 = null;
        }
      }
      struct.set_data_isSet(true);
