...
public class SPUtils {
    ...
    public static void put(String key, Object object) {
        ...
        SharedPreferences sp = ZdStockApp.getAppContext().getSharedPreferences(FILE_NAME, Context.MODE_PRIVATE);
    ...
    public static Object get(String key, Object defaultObject) {
        SharedPreferences sp = ZdStockApp.getAppContext().getSharedPreferences(FILE_NAME,
